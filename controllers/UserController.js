    ...
    insert(data){
     ...
     addLine(dataUser){
        ...
        `
            ...
            <td>
                <button type="button" class="btn btn-primary btn-edit btn-xs btn-flat">Editar</button>
                <button type="button" class="btn btn-danger btn_delete btn-xs btn-flat">Excluir</button>
            </td>
     `;
...
addEventsTr(tr){
    tr.querySelector(".btn_delete").addEventListener("click", e=>{
    ...
    tr.querySelector(".btn-edit").addEventListener("click", e=>{
        ...
        for (let name in json){
         let fild = this.formUpdateEl.querySelector("[name=" + name.replace("_", "") + "]");
            ...
            if(fild){
                ...
                switch(fild.type){
                    ...
                    case 'radio':
                        fild = this.formUpdateEl.querySelector("[name=" + name.replace("_", "") + "][value=" + json[name] +"]");
                        fild.checked = true;   
                    break;
